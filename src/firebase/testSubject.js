...
// todo만 새로 추가
function addTodos(date, id, todoArg1, todoArg2) {
  const db = firebase.firestore();
...
// todo 내용 수정
// async function updateTodos(date, id, todoArg1, todoArg2) {
//   const db = firebase.firestore();
...
// todo 내용 삭제
function deleteTodos(date, id, todoArg1, todoArg2) {
  const db = firebase.firestore();
...
// createSubject("99.99.99", "123", "빨강빨강딸기", {}, changedTodos);

// const changedTodos = [ { todoCheck: '1', todoName: '산딸기빙수' },{ todoCheck: '1', todoName: '산딸기빙수' }];
